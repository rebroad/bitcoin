...
class SegWitTest(BitcoinTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        with self.nodes[0].assert_debug_log(
                expected_msgs=(spend_tx.hash, 'non-mandatory-script-verify-flag (Witness program was passed an empty witness)')):
        ...
        spend_tx.rehash()
        with self.nodes[0].assert_debug_log(
                expected_msgs=(spend_tx.hash, 'mandatory-script-verify-flag-failed (Script evaluated without error but finished with a false/empty top stack element)')):
            test_transaction_acceptance(self.nodes[0], self.test_node, spend_tx, with_witness=False, accepted=False)
