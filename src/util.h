...
#endif
bool ReadConfigFile(const std::string& confPath, std::map<std::string, std::string>& mapSettingsRet, std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet, const bool fNetSpecific = false);
#ifdef WIN32
