...
const int INITIAL_TRAFFIC_GRAPH_VALUE = 9;
...
{
    int mins = ui->trafficGraph->setGraphRangeMins(value);
...
void RPCConsole::updateDetailWidget()
{
    ...
    ui->peerConnectionType->setText(GUIUtil::ConnectionTypeToQString(stats->nodeStats.m_conn_type, stats->nodeStats.fErlay, /* prepend_direction */ true));
