...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-dynmax", _("Experimental feature - adapt the number of blocks downloaded from each peer based on speed (default: 0)"));
    ...
    strUsage += HelpMessageOpt("-sipadisconnects", _("Allow sipa disconnect logic to prevail (default: 0)"));
    ...
    std::string debugCategories = "addrman, alert, bench, block, cmpctblock, coindb, db, http, libevent, lock, mempool, mempoolrej, net, proxy, prune, rand, reindex, rpc, selectcoins, tx, tor, zmq"; // Don't translate these and qt below
