...
{
    argsman.AddArg("-chain=<chain>", "Use the chain <chain> (default: main). Allowed values: main, test, signet, testnet4, regtest", ArgsManager::ALLOW_ANY, OptionsCategory::CHAINPARAMS);
